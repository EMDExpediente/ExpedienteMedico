...
def editarDatoPaciente(persona, idPersona):
    ...
    sql = f"""UPDATE Persona SET nombre = '{persona.nombre}', apellido = '{persona.apellido}',
            apellidoMaterno = '{persona.apellidoMaterno}', ni = '{persona.ni}', fechaNacimiento = '{persona.fechaNacimiento}',
...
def guardarDatoPaciente(persona):
    conexion = ConexionDB()
    sql = f"""INSERT INTO Persona (nombre, apellido, apellidoMaterno,
            ni, fechaNacimiento, edad, antecedentes, correo, telefono, activo) VALUES
            ('{persona.nombre}','{persona.apellido}','{persona.apellidoMaterno}',
            {persona.ni},'{persona.fechaNacimiento}',{persona.edad},'{persona.antecedentes}',
...
class Persona:
    def __init__(self, nombre, apellido, apellidoMaterno, ni,fechaNacimiento, edad, antecedentes,correo, telefono):
        self.idPersona = None
        self.nombre = nombre
    ...
    def __str__(self):
        return f'Persona[{self.nombre},{self.apellido}, {self.apellidoMaterno}, {self.ni},{self.fechaNacimiento},{self.edad},{self.antecedentes},{self.correo},{self.telefono}]'    